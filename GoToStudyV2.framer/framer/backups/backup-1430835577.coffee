...
textContainer = new ScrollComponent width:1250, height:Screen.height, superLayer: bookContainer.content, x:Screen.width/2-1250/2, backgroundColor:"transparent", scrollHorizontal: false
...
textTitle.html = module.thePrinceTitle
...
textBody = new Layer width:textContainer.width, superLayer:textContainer.content, height:2000, y:textTitle.y+textTitle.height, backgroundColor:"transparent"
textBody.html = module.thePrince
textBody.style = {
	"color": "#4A4A4A"
